...
%s
  ...
  <a class="skylink" href="/universe/">
    ...
    <span class="skylink-in">
      ...
      <span class="skylink-h">See how my research projects connect to each other</span>
      <span class="skylink-p">Six constellations, one for each kind of AI crossed with each kind of question. Work that belongs together sits together; a line is drawn where two studies meet.</span>
